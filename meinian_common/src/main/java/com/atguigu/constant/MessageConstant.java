...
public class MessageConstant {
    ...
    public static final String GET_RALETIONSHIP_ERROR = "存在关联数据，请解除关联数据！";
    public static final String QUERY_TRAVELITEMIDS_FAIL = "查询跟团游相关联复选框失败";
    public static final String QUERY_TRAVELITEMIDS_SUCCESS = "查询跟团游相关联复选框成功";
}
